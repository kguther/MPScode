CC=icpc
APCK_DIR=/home/guther/vMPS/arpack/
APCK_LIB=$(APCK_DIR)/lib64/libarpack.a
...
APCK_INCLUDE=-I$(APCK_DIR)/lib64/include/arpackpp
...
debug: $(OBJECTS_DEBUG)
	$(CC) -o $(DEBUG_NAME) $(OBJECTS_DEBUG) $(APCK_LIB) $(CFLAGS) $(LFLAGS) $(MKLFLAGS) $(DMKL)
...
$(OBJECTS_DEBUG): %.dbg: %.cpp 
	$(CC) -c $(CFLAGS_DEBUG) $(APCK_INCLUDE) $(MPI_COMPILE_FLAGS)  $(DMKL) $(INCL_SRC_PATH) $(MKL_INCLUDE) $< -o $@
